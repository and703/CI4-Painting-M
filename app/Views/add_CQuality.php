...
<a href="<?= site_url('reprint') ?>" id="+" style="font-size: 250%; color: #FFF017; font-weight:bold; margin-bottom: 0px;">Press "+" For RePrint Tag</a>
    ...
    <?php 
        ...
        if(isset($wm)){
            ...
            <script language="JavaScript" type="text/javascript">
                window.location.href = "' . site_url('mch') . '";
            </script>';
        }
    ?>
</div>
